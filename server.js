...
// If deployed, use the deployed database mongolab. Otherwise use the local mongoHeadlines database
var MONGODB_URI =
  ...
  axios.get('https://www.cbc.ca/news').then(function(response) {
    ...
    $('a.card.cardFeatured').each(function(i, element) {
      ...
      result.title = $(this)
        .find($('h3.headline'))
        .text();
      result.link = 'https://www.cbc.ca' + $(this).attr('href');
      result.summary = $(this)
    ...
    // grabbing the rest of the main articles
    ...
    // grabbing the rest of the front-page news without description
